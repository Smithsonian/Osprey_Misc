...
create table folders (
    ...
    updated_at timestamp DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	CONSTRAINT fk_foldproj FOREIGN KEY (project_id) REFERENCES projects(project_id) ON UPDATE CASCADE ON DELETE CASCADE
) DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE folders_md5 (
    ...
    md5             int,
    updated_at      timestamp DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	CONSTRAINT fk_foldmd5 FOREIGN KEY (folder_id) REFERENCES folders(folder_id) ON UPDATE CASCADE ON DELETE CASCADE
) DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE folders_badges (
    ...
    updated_at      timestamp DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	CONSTRAINT fk_foldbadge FOREIGN KEY (folder_id) REFERENCES folders(folder_id) ON UPDATE CASCADE ON DELETE CASCADE
) DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE files (
	...
	CONSTRAINT fk_foldfile FOREIGN KEY (folder_id) REFERENCES folders(folder_id) ON UPDATE CASCADE ON DELETE CASCADE
) DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE files_checks (
	...
	updated_at timestamp DEFAULT CURRENT_TIMESTAMP
	ON UPDATE CURRENT_TIMESTAMP,
	CONSTRAINT fckecks_files FOREIGN KEY (file_id) REFERENCES files(file_id) ON UPDATE CASCADE ON DELETE CASCADE,
	CONSTRAINT fckecks_folders FOREIGN KEY (folder_id) REFERENCES folders(folder_id) ON UPDATE CASCADE ON DELETE CASCADE
) DEFAULT CHARSET=utf8mb4;
...
create table files_exif (
    ...
    value text,
	updated_at timestamp DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	CONSTRAINT fexif_files FOREIGN KEY (file_id) REFERENCES files(file_id) ON UPDATE CASCADE ON DELETE CASCADE
) DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE file_postprocessing (
    ...
    post_info text,
    updated_at timestamp DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	CONSTRAINT fpost_files FOREIGN KEY (file_id) REFERENCES files(file_id) ON UPDATE CASCADE ON DELETE CASCADE
) DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE projects_stats (
    ...
    updated_at timestamp DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	CONSTRAINT pstats_proj FOREIGN KEY (project_id) REFERENCES projects(project_id) ON UPDATE CASCADE ON DELETE CASCADE
) DEFAULT CHARSET=utf8mb4;
...
ALTER TABLE qc_projects ADD CONSTRAINT qcp_uid1	FOREIGN KEY (user_id) REFERENCES users(user_id)	ON UPDATE CASCADE ON DELETE CASCADE;
...
create table qc_settings (
	...
	updated_at timestamp DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	CONSTRAINT qset_proj FOREIGN KEY (project_id) REFERENCES projects(project_id) ON UPDATE CASCADE ON DELETE CASCADE
) DEFAULT CHARSET=utf8mb4;
...
create table qc_folders (
	...
	qc_level VARCHAR(64),
    updated_at timestamp DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	CONSTRAINT qfol_fol FOREIGN KEY (folder_id) REFERENCES folders(folder_id) ON UPDATE CASCADE ON DELETE CASCADE
) DEFAULT CHARSET=utf8mb4;
...
create table qc_files (
    ...
    qc_ip VARCHAR(64),
    updated_at timestamp DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	CONSTRAINT qc_fold FOREIGN KEY (folder_id) REFERENCES folders(folder_id) ON UPDATE CASCADE ON DELETE CASCADE,
	CONSTRAINT qc_files FOREIGN KEY (file_id) REFERENCES files(file_id) ON UPDATE CASCADE ON DELETE CASCADE
) DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE data_reports (
    ...
    updated_at timestamp DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	CONSTRAINT project_id FOREIGN KEY (project_id) REFERENCES projects(project_id) ON UPDATE CASCADE ON DELETE CASCADE
);
